...
{
    public partial class LC001 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineVolume = table.Column<decimal>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Automobiles_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Automobiles_Bans_BanId",
                        column: x => x.BanId,
                        principalTable: "Bans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Automobiles_Cities_CityId",
                        column: x => x.CityId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Automobiles_SpeedBoxes_SpeedBoxId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Automobiles_ApplicationUserId",
                table: "Automobiles",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Automobiles_BanId",
                table: "Automobiles",
                column: "BanId");

            migrationBuilder.CreateIndex(
                name: "IX_Automobiles_CityId",
                table: "Automobiles",
                column: "CityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Automobiles_SpeedBoxId",
                table: "Automobiles",
                column: "SpeedBoxId");
